...
//            System.out.println(response1.isAcknowledged());
     ...
     */
    @Test
    public void closeIndex() throws ExecutionException, InterruptedException {
        // 查看索引是打开还是关闭状态
    ...
    @Test
    public void openIndex() throws ExecutionException, InterruptedException {
        ClusterStateResponse clusterStateResponse = client.admin().cluster().state(new ClusterStateRequest().indices(index)).get();
...
//        System.out.println("delete size:" + deleted);
     ...
     */
    @Test
    public void getIndexAlias() throws ExecutionException, InterruptedException {
